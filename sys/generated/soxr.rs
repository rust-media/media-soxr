...
pub type soxr_input_fn_t =
    ::std::option::Option<unsafe extern "C" fn(input_fn_state: *mut ::std::os::raw::c_void, data: *mut soxr_in_t, requested_len: usize) -> usize>;
impl soxr_datatype_t {
    pub const SOXR_FLOAT32_I: soxr_datatype_t = soxr_datatype_t::SOXR_FLOAT32;
}
impl soxr_datatype_t {
    pub const SOXR_FLOAT64_I: soxr_datatype_t = soxr_datatype_t::SOXR_FLOAT64;
}
impl soxr_datatype_t {
    pub const SOXR_INT32_I: soxr_datatype_t = soxr_datatype_t::SOXR_INT32;
}
impl soxr_datatype_t {
    pub const SOXR_INT16_I: soxr_datatype_t = soxr_datatype_t::SOXR_INT16;
}
impl soxr_datatype_t {
    pub const SOXR_FLOAT32_S: soxr_datatype_t = soxr_datatype_t::SOXR_SPLIT;
}
#[repr(i32)]
...
unsafe extern "C" {
    ...
    pub fn soxr_set_input_fn(resampler: soxr_t, arg1: soxr_input_fn_t, input_fn_state: *mut ::std::os::raw::c_void, max_ilen: usize) -> soxr_error_t;
    ...
    pub fn soxr_quality_spec(recipe: ::std::os::raw::c_ulong, flags: ::std::os::raw::c_ulong) -> soxr_quality_spec_t;
